...
export default function MuralsComparisonTable({
    data,
    cohortA_label,
    cohortB_label,
    dimensionLabel = "Evento", // "Evento" | "Región" | "Grupo"
}: {
    data: CompareResult;
    ...
    return (
        <div style={{ marginTop: 16, maxWidth: "90vw", overflowX: "auto", paddingBottom: 380 }}>
            ...
            {data?.limitations?.length ? <div style={{ height: 14 }} /> : null}
